...
class Csz_model extends CI_Model
{
     ...
     * @return	string
     */
    public function getHtmlContent($ori_content, $url_segment)
    { /* Calculate the HTML code */
     ...
     * @return	string
     */
    public function bannerInHtml($content)
    { /* Find the banner in content */
     ...
     * @return	string
     */
    public function widgetInHtml($content)
    { /* Find the widget in content */
        $txt_nonhtml = strip_tags($content);
     ...
     * @return	string
     */
    public function frmNameInHtml($content, $url_segment)
    { /* Find the form in content */
        $txt_nonhtml = strip_tags($content);
     ...
     * @return	string
     */
    public function addFrmToHtml($content, $frm_name, $status = '')
    { /* Add the form in content */
        $CI =& get_instance();
        ...
        if ($form_data && $form_data !== false) {
            ...
            if ($field_data && $field_data !== false) {
                foreach ($field_data as $field) {
                    ...
                    } elseif ($field['field_type'] == 'datepicker') {
                    ...
                    } elseif ($field['field_type'] == 'button' || $field['field_type'] == 'reset' || $field['field_type'] == 'submit') {
    ...
    public function sendEmail($to_email, $subject, $message, $from_email, $from_name = '', $bcc = '', $reply_to = '', $alt_message = '', $attach_file = array(), $save_log = true)
    {
        ...
        } elseif ($protocal == 'sendmail' && $load_conf->sendmail_path) {
