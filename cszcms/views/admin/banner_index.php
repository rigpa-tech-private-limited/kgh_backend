            ...
            <table class="table table-bordered table-hover table-striped">
                <thead>
                    <tr>
                        ...
                        <th width="20%" class="text-center"><?php echo $this->lang->line('id_col_table'); ?></th>
                        <th width="30%" class="text-center"><?php echo $this->lang->line('banner_img'); ?></th>
                        ...
                        <th width="20%" class="text-center">Display on</th>
                        <th width="20%"></th>
                    </tr>
                </thead>
                <tbody>
    ...
    ?>
        ...
        ?>
                        ...
                        foreach ($banner as $u) {
                            ...
                            echo '<td class="text-center"'.$inactive.'>'.(($u['mobile_flag']==0)?'Website':'Mobile').'</td>';
                            echo '<td class="text-center"'.$inactive.'><a href="'.$this->Csz_model->base_link().'/admin/banner/edit/' . $u['banner_mgt_id'] . '" class="btn btn-default btn-sm" role="button"><i class="glyphicon glyphicon-pencil"></i>  '.$this->lang->line('btn_edit').'</a>';
                            echo '</td></tr>';
                        } ?>
                    <?php
    } ?>
        ...
        <!--span class="remark"><?php echo $this->lang->line('banner_indexremark'); ?></span><br-->
	<br>
