    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="control-group" style="height:0;visibility:hidden">
            ...
            $data = array(
                ...
                'value' => set_value('start_date', '1969-12-12', false)
            );
            echo form_input($data);
            ?>
        </div> <!-- /control-group -->
        <div class="control-group" style="height:0;visibility:hidden">
            ...
            $data = array(
                ...
                'autofocus' => 'true',
                'class' => 'form-control form-datepicker',
                'value' => set_value('end_date', '1969-12-12', false)
            );
            echo form_input($data);
            ?>
        </div> <!-- /control-group -->
        ...
        <br>
        <div class="control-group">
            <label class="control-label" for="mobile"><?php echo 'For'; ?></label>
            <?php
                $att = 'id="mobile_flag" class="form-control" ';
                $data = array();
                $data['0'] = 'Web';
                $data['1'] = 'Mobile';
                echo form_dropdown('mobile_flag', $data, '', $att);
            ?>
        </div>
        <br><br>
