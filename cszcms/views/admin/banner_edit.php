...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <div class="control-group" style="height:0;visibility:hidden">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div><img class="img-thumbnail img-responsive" src="<?php
                    ...
                    <?php if ($banner->img_path != "" && $banner->img_path != null) {
                        ?><label for="del_file"><input type="checkbox" name="del_file" id="del_file" value="<?php echo $banner->img_path?>"> <span class="remark">Delete File</span></label><?php
                    } ?>
                    <?php
                    $data = array(
                        'name' => 'file_upload',
        ...
        <br>
        <div class="control-group">
            <label class="control-label" for="mobile_flag"><?php echo 'For'; ?></label>
            <?php
                $att = 'id="mobile_flag" class="form-control" ';
                $data = array();
                $data['0'] = 'Web';
                $data['1'] = 'Mobile';
                echo form_dropdown('mobile_flag', $data, $banner->mobile_flag, $att);
            ?>
        </div>
        <br><br>
