...
*/
$route['api/rest']['get']          	       = 'api/rest';
$route['api/rest/articles/(:num)']['get']    = 'api/rest/articles/$1';
$route['api/rest/programs']['get']    = 'api/rest/programs';
$route['api/rest/studentcenter']['get']    = 'api/rest/studentcenter';
$route['api/rest/sportscenter/(:num)']['get']    = 'api/rest/sportscenter/$1';
$route['api/rest/banners']['get']    = 'api/rest/banners';
$route['api/rest/web_banners']['get']    = 'api/rest/web_banners';

$route['/'] = "admin/plugin/article";
$route['admin'] = "admin/plugin/article";
$route['admin/index'] = "admin/plugin/article";
